function validate(){
  ...
  if(year > 2100){
    ...
    alert("Invalid year your year should have a 4 digit value");
  }
  else if (year === ""){
    alert("Empty field. Please input your year of birth");
  }
  else{
    d.setFullYear(year);
  }
  ...
  if(month <= 0 || month > 12){
    alert("Invalid month input. ie use 01 if born in january")
  }else{
    d.setMonth(month);
  }
  ...
  if (day <= 0 || day > 31){
    alert("Please enter a valid date input")
  }else{
    d.setDate(date);
  }
}
